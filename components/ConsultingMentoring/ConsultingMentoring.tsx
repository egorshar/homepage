...
const mentoringHighlights = [
  {
    ...
    description:
      'Помогаю собрать фундамент фронтенда: от базового HTML/CSS/JS до первого сайта, который выходит в прод. Разбираем путь по шагам на примере реального клиента, чтобы видеть направление и темп.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Показываю, как встроить AI-инструменты в ежедневную разработку: выбор стека, код-ревью, тесты, ресёрч и документацию — всё с пошаговой настройкой и контрольными точками.',
  },
  {
    title: 'Управление фронтенд-командой',
    description:
      'Передаю знания по управлению фронтенд-командой: строим процессы, формируем культуру ревью, настраиваем взаимодействие с продуктом и растим тимлидов без хаоса.',
  },
];
...
const trustSignals = [
  ...
  'Комбинирую опыт архитектора, тимлида и продакт-ментора — вместе внедряем AI и инструменты для роста команды.',
  'Работаем в формате «делаем вместе»: созвоны, ревью, чек-листы и понятные артефакты.',
  'Один из наставляемых дошёл от полного нуля до коммерческого релиза за 3 месяца — показываю этот маршрут и набор решений.',
];
        ...
        <section className="pt-16">
          ...
          <AnimatedText className="mt-6 max-w-3xl text-2xl md:text-[28px] leading-snug text-slate-800 dark:text-slate-200">
            <p>
              ...
              опыта до запуска продакшн-проектов. Обучаю фронтенду с нуля на
              реальных кейсах — покажу, как один из клиентов прошёл путь от
              «не знаю ничего» до релиза. Помогаю встроить AI-инструменты в
              ежедневную работу и делюсь практиками управления
              фронтенд-командой: архитектура, перформанс, лидерство, процессы.
            </p>
          </AnimatedText>
        </section>
